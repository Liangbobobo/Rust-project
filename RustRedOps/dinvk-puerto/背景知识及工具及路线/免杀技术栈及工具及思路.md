...
1. 最准确和硬核的方式是使用WinDbg本地验证
2. Vergilius,主要解析内核符号（如 ntkrnlmp.pdb）
3. Geoff Chappell API Set,google搜索 site:geoffchappell.com "API Set Schema"
4. Process Hacker (phnt)：这是目前最准确的 C 头文件集合(https://github.com/winsiderss/phnt)



## 实践中的方法

在学习一个新项目中,首先对新项目实现的思路做总结,方便重构的时候对比,哪个方案更好
